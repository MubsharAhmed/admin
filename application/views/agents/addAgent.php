        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addAgent" action="<?php echo base_url() ?>addNewAgent" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
...
<script src="<?php echo base_url(); ?>assets/js/addAgent.js" type="text/javascript"></script>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>updateAgent" method="post" id="editAgent" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="manager" name="manager">
                                            ...
                                            <option value="<?=$manager->id?>" <?=$manager->id==$parent_id?' selected':''?>><?=$manager->name?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
...
<script src="<?php echo base_url(); ?>assets/js/editAgent.js" type="text/javascript"></script>
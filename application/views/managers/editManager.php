        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>updateManager" method="post" id="editManager" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
...
<script src="<?php echo base_url(); ?>assets/js/editManager.js" type="text/javascript"></script>